document.addEventListener("DOMContentLoaded", () => {
   ...
   /*const uTetrimino = [ // u tetrimino
     [gridWidth, gridWidth + 1, gridWidth + 2, gridWidth * 2, gridWidth * 2 + 2],
     [0, 1, gridWidth + 1, gridWidth * 2, gridWidth * 2 + 1], 
     [0, 2, gridWidth, gridWidth + 1, gridWidth + 2], 
     [1, 2, gridWidth + 1, gridWidth * 2 + 1, gridWidth * 2 + 2]
   ]*/
 
   /*const singleTetrimino = [ 
     [1, gridWidth + 1],
   ...
   /*const crossTetrimino = [
     [1, gridWidth, gridWidth + 2, gridWidth * 2 + 1],
     [1, gridWidth, gridWidth + 2, gridWidth * 2 + 1], 
     [1, gridWidth, gridWidth + 2, gridWidth * 2 + 1],
     [1, gridWidth, gridWidth + 2, gridWidth * 2 + 1]
   ]*/
 
   const multiTetrimino = [
   ...
   const tetriminoArr = [lTetrimino, zTetrimino, tTetrimino, oTetrimino, iTetrimino, doubleTetrimino, multiTetrimino]
   ...
   // this function assigns keys to other functions
   function controls(e) {
     if(e.keyCode === 65) {
       moveTetriminoLeft();
   ...
   const nextTetrimino = [
     ...
     //[1, displayWidth + 1], // singleTetrimino
   ...
   startBtn.addEventListener("click", () => {
     if(timerId) {
       ...
       draw();
       timerId = setInterval(moveTetriminoDown, 500);
       nextRandom = Math.floor(Math.random() * tetriminoArr.length);
       displayNextShape();
     }
   })
